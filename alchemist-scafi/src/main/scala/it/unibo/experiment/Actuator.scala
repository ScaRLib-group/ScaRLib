...
class Actuator[T, P <: Position[P]](env: Environment[T, P], distribution: TimeDistribution[T], actionSpace: Seq[Action])
    extends ActuatorReaction(env, distribution, actionSpace) {
